...
//     e.preventDefault();
//     emailjs.sendForm('service_7treexm', 'template_5ocrf0i', form.current, 'Pgd_RDL307Yor7og0')
//       .then((result) => {
//         setOpen(true);
//         form.current.reset();
//       }, (error) => {
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    emailjs.sendForm('service_9rfsynb', 'template_y7vs0ja', form.current, 'A5Wbi1H8u4HnaaWqE')
      .then((result) => {
        setOpen(true);
        setError(null);
        form.current.reset();
